...
namespace PAMS_2._0.Controllers.Psicologia
{
    public class FamController : Controller
    {
        ...
        public IActionResult Create(Familiares familiares)
        {
            ...
            {
                var paciente = _context.Paciente.Find(familiares.idPaciente);
                ...
                modelo.paciente = _context.Paciente.Find(familiares.idPaciente);
        ...
        public IActionResult Delete(int? id)
        {
            ...
            modelo.paciente = _context.Paciente.Find(idP);
             modelo.Sesion = HttpContext.Session.GetString("usuario");
            modelo.rol = HttpContext.Session.GetString("rol");
            return RedirectToAction("DetallesGenerales", "Pacientes", new { id = idP, tabname = "Familiares" });
